            ...
            <div class="card card- card-outline">
                <div class="card-header" style="background-color: #d1ccb6;">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo base_url('outlet/tambah') ?>" class="btn btn-" style="background-color: #aa858c;"><i class="fa fa-plus" style="color: #d1ccb6;"> Tambah Data</i></a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #d1ccb6;">
                                            <a class="btn btn-" href="<?php echo base_url('outlet/ubah/')  .  $row['id_outlet'] ?>"><i class="fa fa-edit" style="background-color: #aa858c; color: #d1ccb6;"></i></a>
                                            <a class="btn btn-" onclick="return confirm('Apakah Anda Yakin?')" href="<?php echo base_url('outlet/hapus/')   .  $row['id_outlet']?>"><i class="fa fa-trash" style="background-color: #aa858c; color: #d1ccb6;"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
