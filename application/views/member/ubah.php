                        ...
                        <div class="col-md-12">
                            <form method="post">
                                <div class="form-group" style="color: #aa858c;">
                                    ...
                                    <input type="number" name="id_member" id="id_member" class="form-control"  style="background-color: #d2cda3;" placeholder="ID member" required="" value="<?php echo $member['id_member'] ?>" readonly>
                                </div>
                                <div class="form-group" style="color: #aa858c;">
                                    <label for="">Nama </label>
                                    <input type="text" name="nama" id="nama" class="form-control"  style="background-color: #d2cda3;" placeholder="Nama" required="" value="<?php echo $member['nama'] ?>">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
                                    <label for="">Alamat</label>
                                    <input type="text" name="alamat" id="alamat" class="form-control"  style="background-color: #d2cda3;" placeholder="Alamat" required="" value="<?php echo $member['alamat'] ?>">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
                                    <label for="">Tlp</label>
                                    <input type="text" name="tlp" id="tlp" class="form-control"  style="background-color: #d2cda3;" placeholder="Tlp" required="" value="<?php echo $member['tlp'] ?>">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
