                        ...
                        <div class="col-md-12">
                            <form method="post">
                                <div class="form-group" style="color: #aa858c;">
                                    ...
                                    <input type="number" name="id_user" id="id_user" class="form-control"  style="background-color: #d2cda3;" placeholder="ID user" required="" value="<?php echo $user['id_user'] ?>" readonly>
                                </div>
                                <div class="form-group" style="color: #aa858c;">        
                                ...
                                <div class="form-group" style="color: #aa858c;">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control"  style="background-color: #d2cda3;" placeholder="Nama" required="" value="<?php echo $user['nama'] ?>">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
                                    <label for="">Username</label>
                                    <input type="text" name="username" id="username" class="form-control"  style="background-color: #d2cda3;" placeholder="Username" required="" value="<?php echo $user['username'] ?>">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
                                    <label for="">Password</label>
                                    <input type="text" name="password" id="password" class="form-control"  style="background-color: #d2cda3;" placeholder="Password" required="">
                                </div>
                                <div class="form-group" style="color: #aa858c;">
